...
- **Hinweis Worktree-Isolation:** Worktrees basieren auf altem Session-HEAD (`3ecf4ce`) statt current main → Agenten müssen im Worktree zuerst `git checkout -B <branch> main`; geteilten Checkout nicht anfassen. Für B5c/B4c/B2/B1 explizit instruieren.
